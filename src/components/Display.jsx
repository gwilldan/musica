...
const Display = () => {
	...
	return (
		<main className=" h-[505px] lg:h-[373px] w-full lg:w-[64%] xl:w-[80%] bg-mainGreen lg:max-w-[785px] rounded-[40px] text-mainWhite font-medium px-[34px] py-[36px] relative overflow-hidden shadow-[0_15px_22px_-20px_rgba(122,144,150,1)]">
			<img
				src={vector}
